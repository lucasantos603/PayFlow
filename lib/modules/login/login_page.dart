...
import 'package:payflow/shared/widget/social_login/social_login_buttom.dart';
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              bottom: size.height * 0.05, left: 0, right: 0,
              child: Column(
                children: [
                ...
                Padding(
                  ...
                  child: SocilLoginButton(onTap: (){print("cliclou");},),
                )
              ],),
            ),
          ],
